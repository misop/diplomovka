...
On GPU Linear Blend Skinning, as described in \cite{Kavan-07-SDQ}, is used to combine skinning matrices corresponding to each vertex.
...
\begin{figure}[ht]
    ...
    \caption[Tessellation and smoothing]{Tessellation. Not tessellated mesh (a); Tessellated mesh wit 20 subdivisions (b); Tessellated mesh with self intersection (c); Tessellated mesh with scaling (d);}
